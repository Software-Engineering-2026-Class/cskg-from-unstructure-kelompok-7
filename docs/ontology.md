...
**Current status:** CVE URI linking is implemented and verified (1 SEPSES CVE URI confirmed in runtime statistics). Linking for CWE IDs and MITRE ATT&CK technique URIs is planned for future iterations.
